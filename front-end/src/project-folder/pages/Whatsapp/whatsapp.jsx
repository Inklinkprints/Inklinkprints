...
import "./whatsapp.css";
import Whatsapplogo from "../../assets/Inklink-whatsapp-logo.png"
  ...
  return (
    <div className="whatsapp-container">
      <div className="WA_Chat_Widget" data-position="bottom-right">
        <div
          className="WA_ChatBox"
          style={{ display: isChatboxVisible ? "block" : "none" }}
        >
          <div className="WA_ChatBox_Header">
            <div className="avatarBox">
              <img src={Whatsapplogo} alt="Chat Avatar" />
            </div>
            <div className="infoBox">
              <h4 className="name">InkLink Prints</h4>
              <span className="answer_time">Typically responds within a day</span>
            </div>
